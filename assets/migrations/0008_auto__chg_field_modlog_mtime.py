...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ModLog.mtime'
        db.alter_column(u'assets_modlog', 'mtime', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'ModLog.mtime'
        db.alter_column(u'assets_modlog', 'mtime', self.gf('django.db.models.fields.DateField')())
