...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ModLog'
        db.create_table(u'assets_modlog', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('asset', self.gf('django.db.models.fields.CharField')(max_length=60)),
            ('mtime', self.gf('django.db.models.fields.DateField')()),
            ('field', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('oldvalue', self.gf('django.db.models.fields.CharField')(max_length=500, blank=True)),
            ('newvalue', self.gf('django.db.models.fields.CharField')(max_length=500, blank=True)),
        ))
        db.send_create_signal(u'assets', ['ModLog'])


    def backwards(self, orm):
        # Deleting model 'ModLog'
        db.delete_table(u'assets_modlog')
    ...
    models = {
        ...
        u'assets.modlog': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mtime': ('django.db.models.fields.DateField', [], {}),
